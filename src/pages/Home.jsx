...
const Home = () => {
    return (
        <div>
            ...
            {/*Section 2*/}
            <div className='bg-pure-grey-5 text-richblack-300'>
                    ...
                    <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
                        ...
                        <div className='flex flex-col gap-10 w-[40%] items-start'>
                            <div className='text-[16px]'>
                                The modern LuckyNotion is the dictates its own terms. Today, to be a competitive specialist requires more than professional skills.
                            </div>
                            <CTAButton active={true} linkto={"/signup"}>
                                <div>
                                    Learn more
